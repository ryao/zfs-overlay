...
SRC_URI="http://vault.centos.org/7.1.1503/updates/Source/SPackages/kernel-${RV}.src.rpm"
SRC_URI="${SRC_URI} http://mirror.cc.columbia.edu/pub/linux/centos/7.1.1503/updates/x86_64/Packages/kernel-${RV}.x86_64.rpm"
